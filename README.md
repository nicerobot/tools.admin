...
[![CI](https://github.com/nicerobot/tools.admin/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/nicerobot/tools.admin/actions/workflows/ci.yml)
...
```yaml
- uses: nicerobot/tools.admin/go-tooling@v3
  with:
    target: check
```
...
jobs:
  cleanup:
    uses: nicerobot/tools.admin/.github/workflows/cleanup-runs.yml@main
```
